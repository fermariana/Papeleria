...
public class MainActivity6 extends AppCompatActivity implements View.OnClickListener {
    ...
    String UPLOAD_URL ="https://192.168.0.109/papeleria/insertar_producto.php";
    ...
    private void uploadImage(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UPLOAD_URL,
            ...
            //Showing toast
            Toast.makeText(MainActivity6.this, volleyError.getMessage().toString(), Toast.LENGTH_LONG).show();
        }){
            @Override
